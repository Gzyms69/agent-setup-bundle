...
| Backend architecture, API contracts, DB schema (Postgres/SQLite) | `skill-backend-architect` |
...
| 5-axis systematic code review before completing tasks | `skill-code-review` |
